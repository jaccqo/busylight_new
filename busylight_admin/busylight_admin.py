...
#nuitka busylight_admin.py --standalone --follow-imports --output-dir=build --assume-yes-for-downloads --windows-icon-from-ico=icon.ico  --include-data-dir=templates=templates
